...
The "Výkon" tab displays transmit power in watts. During reception it
shows ``0 W``. The S‑meter tab continuously polls the radio's meter, so
it indicates signal strength when receiving and mirrors the power meter
when transmitting.
