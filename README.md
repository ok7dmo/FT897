...
If no CAT connection is active when you choose *Load memories from radio…*,
the application will automatically open the selected serial port solely for
the duration of the memory transfer.
