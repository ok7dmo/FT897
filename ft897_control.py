...
class RadioControlApp(QMainWindow):
    def __init__(self):
        ...
        self.memory_presets = {
            "FM rozhlas": [
                ("Color Music Radio", 92_500_000, "FM"),
                ("Country Radio Jindřichův Hradec", 92_000_000, "FM"),
                ("Country Radio Strakonice", 94_600_000, "FM"),
                ("Country Radio České\xa0Budějovice", 94_700_000, "FM"),
                ("Country Radio Písek", 101_500_000, "FM"),
                ("Country Radio Český\xa0Krumlov", 101_600_000, "FM"),
                ("Country Radio Dačice", 101_800_000, "FM"),
                ("Country Radio Tábor", 101_800_000, "FM"),
                ("Country Radio Prachatice", 88_200_000, "FM"),

                ("ČRo České\xa0Budějovice\xa0– Slavonice", 88_200_000, "FM"),
                ("ČRo České\xa0Budějovice\xa0– Tábor", 103_900_000, "FM"),
                ("ČRo České\xa0Budějovice\xa0– České\xa0Budějovice", 106_400_000, "FM"),

                ("ČRo Dvojka\xa0– Jindřichův\xa0Hradec", 89_600_000, "FM"),
                ("ČRo Dvojka\xa0– Písek", 98_900_000, "FM"),
                ("ČRo Dvojka\xa0– Nové\xa0Hrady", 102_200_000, "FM"),
                ("ČRo Dvojka\xa0– Slavonice", 103_300_000, "FM"),
                ("ČRo Dvojka\xa0– České\xa0Budějovice", 103_700_000, "FM"),

                ("ČRo Plus\xa0– Strakonice", 95_700_000, "FM"),
                ("ČRo Plus\xa0– České\xa0Budějovice", 98_000_000, "FM"),
                ("ČRo Plus\xa0– Prachatice", 98_000_000, "FM"),
                ("ČRo Plus\xa0– Český\xa0Krumlov", 98_200_000, "FM"),
                ("ČRo Plus\xa0– Jindřichův\xa0Hradec", 99_500_000, "FM"),
                ("ČRo Plus\xa0– Písek", 106_000_000, "FM"),

                ("ČRo Radiožurnál\xa0– České\xa0Budějovice", 91_100_000, "FM"),
                ("ČRo Radiožurnál\xa0– Písek", 97_000_000, "FM"),

                ("ČRo Vltava\xa0– České\xa0Budějovice", 96_100_000, "FM"),
                ("ČRo Vltava\xa0– Písek", 105_200_000, "FM"),
                ("ČRo Vltava\xa0– Kaplice", 105_900_000, "FM"),
                ("ČRo Vltava\xa0– Kašperské\xa0Hory", 107_200_000, "FM"),

                ("Evropa\xa02\xa0– Prachatice", 89_300_000, "FM"),
                ("Evropa\xa02\xa0– České\xa0Budějovice", 90_500_000, "FM"),
                ("Evropa\xa02\xa0– Strakonice", 95_300_000, "FM"),
                ("Evropa\xa02\xa0– Český\xa0Krumlov", 102_500_000, "FM"),

                ("Fajn\xa0Radio\xa0– Tábor", 87_600_000, "FM"),
                ("Fajn\xa0Radio\xa0– Písek", 87_900_000, "FM"),
                ("Fajn\xa0Radio\xa0– Tábor-ubytovna", 97_200_000, "FM"),
                ("Fajn\xa0Radio\xa0– České\xa0Budějovice", 101_900_000, "FM"),

                ("Frekvence\xa01\xa0– České\xa0Budějovice", 94_100_000, "FM"),

                ("Hey\xa0Radio\xa0– České\xa0Budějovice", 91_600_000, "FM"),
                ("Hey\xa0Radio\xa0– Tábor", 99_900_000, "FM"),
                ("Hey\xa0Radio\xa0– Český\xa0Krumlov", 100_000_000, "FM"),

                ("Hitrádio\xa0Faktor\xa0– Kaplice", 87_600_000, "FM"),
                ("Hitrádio\xa0Faktor\xa0– Tábor", 88_000_000, "FM"),
                ("Hitrádio\xa0Faktor\xa0– Český\xa0Krumlov", 88_000_000, "FM"),
                ("Hitrádio\xa0Faktor\xa0– Strakonice", 90_100_000, "FM"),
                ("Hitrádio\xa0Faktor\xa0– Písek", 93_600_000, "FM"),
                ("Hitrádio\xa0Faktor\xa0– Jindřichův\xa0Hradec", 94_600_000, "FM"),
                ("Hitrádio\xa0Faktor\xa0– České\xa0Budějovice", 104_300_000, "FM"),

                ("Hitrádio\xa0FM\xa0Plus\xa0– Sedlec-Prčice", 92_400_000, "FM"),

                ("Netro\xa0Life\xa0Radio\xa0– České\xa0Budějovice", 100_800_000, "FM"),

                ("Radio\xa01\xa0– České\xa0Budějovice", 100_200_000, "FM"),

                ("Radio\xa0Beat\xa0– Český\xa0Krumlov", 92_900_000, "FM"),
                ("Radio\xa0Beat\xa0– Písek", 96_600_000, "FM"),
                ("Radio\xa0Beat\xa0– Tábor", 98_600_000, "FM"),
                ("Radio\xa0Beat\xa0– Dačice", 100_800_000, "FM"),
                ("Radio\xa0Beat\xa0– Jindřichův\xa0Hradec", 101_000_000, "FM"),
                ("Radio\xa0Beat\xa0– České\xa0Budějovice", 101_200_000, "FM"),
                ("Radio\xa0Beat\xa0– Strakonice", 107_700_000, "FM"),
                ("Radio\xa0Beat\xa0– Prachatice", 107_900_000, "FM"),

                ("Rádio\xa0Blaník\xa0– České\xa0Budějovice", 88_400_000, "FM"),
                ("Rádio\xa0Blaník\xa0– Prachatice", 92_800_000, "FM"),
                ("Rádio\xa0Blaník\xa0– Písek", 100_200_000, "FM"),
                ("Rádio\xa0Blaník\xa0– Český\xa0Krumlov", 104_700_000, "FM"),
                ("Rádio\xa0Blaník\xa0– Strakonice", 104_800_000, "FM"),
                ("Rádio\xa0Blaník\xa0– Jindřichův\xa0Hradec", 105_100_000, "FM"),

                ("Rádio\xa0Bonton\xa0– Sezimovo\xa0Ústí", 91_700_000, "FM"),
                ("Rádio\xa0Bonton\xa0– České\xa0Budějovice", 98_700_000, "FM"),
                ("Rádio\xa0Bonton\xa0– Strakonice", 100_400_000, "FM"),

                ("Rádio\xa0Česká\xa0Kanada\xa0– Dačice", 92_900_000, "FM"),
                ("Rádio\xa0Česká\xa0Kanada\xa0– Jindřichův\xa0Hradec", 103_600_000, "FM"),

                ("Radio\xa0Dechovka\xa0– Tábor", 94_500_000, "FM"),
                ("Radio\xa0Dechovka\xa0– Češnovice", 95_500_000, "FM"),
                ("Radio\xa0Dechovka\xa0– České\xa0Budějovice", 96_800_000, "FM"),
                ("Radio\xa0Dechovka\xa0– Písek", 99_400_000, "FM"),
                ("Radio\xa0Dechovka\xa0– Strakonice", 101_100_000, "FM"),

                ("Rádio\xa0Impuls\xa0– Kašperské\xa0Hory", 98_400_000, "FM"),
                ("Rádio\xa0Impuls\xa0– České\xa0Budějovice", 102_900_000, "FM"),

                ("Radio\xa0Kiss\xa0– České\xa0Budějovice", 87_800_000, "FM"),
                ("Radio\xa0Kiss\xa0– Dačice", 89_000_000, "FM"),
                ("Radio\xa0Kiss\xa0– Písek", 92_600_000, "FM"),
                ("Radio\xa0Kiss\xa0– Jindřichův\xa0Hradec", 99_100_000, "FM"),
                ("Radio\xa0Kiss\xa0– Český\xa0Krumlov", 99_300_000, "FM"),
                ("Radio\xa0Kiss\xa0– Prachatice", 101_400_000, "FM"),
                ("Radio\xa0Kiss\xa0– Strakonice", 102_000_000, "FM"),

                ("Rádio\xa0Krokodýl\xa0– Dačice", 98_500_000, "FM"),

                ("Rádio\xa0Otava\xa0– Strakonice", 88_300_000, "FM"),
                ("Rádio\xa0Otava\xa0– Blatná", 89_700_000, "FM"),
                ("Rádio\xa0Otava\xa0– Horažďovice", 92_200_000, "FM"),
                ("Rádio\xa0Otava\xa0– Písek", 92_200_000, "FM"),

                ("Radio\xa0Proglas\xa0– Tábor", 88_700_000, "FM"),
                ("Radio\xa0Proglas\xa0– Písek", 89_500_000, "FM"),
                ("Radio\xa0Proglas\xa0– České\xa0Budějovice", 92_300_000, "FM"),
                ("Radio\xa0Proglas\xa0– Nové\xa0Hrady", 107_500_000, "FM"),

                ("Radio\xa0Spin\xa0– České\xa0Budějovice", 106_800_000, "FM"),
                ("Radio\xa0Spin\xa0– Tábor", 107_800_000, "FM"),

                ("Rádio\xa0Prostor\xa0– České\xa0Budějovice", 89_800_000, "FM"),

                ("Rock\xa0Radio\xa0Jižní\xa0Čechy\xa0– Jindřichův\xa0Hradec", 89_200_000, "FM"),
                ("Rock\xa0Radio\xa0Jižní\xa0Čechy\xa0– Český\xa0Krumlov", 89_300_000, "FM"),
                ("Rock\xa0Radio\xa0Jižní\xa0Čechy\xa0– České\xa0Budějovice", 99_700_000, "FM"),
                ("Rock\xa0Radio\xa0Jižní\xa0Čechy\xa0– Tábor", 106_800_000, "FM"),

                ("Rock\xa0Radio\xa0Jižní\xa0a\xa0střední\xa0Čechy\xa0– Písek", 89_000_000, "FM"),
                ("Rock\xa0Radio\xa0Jižní\xa0a\xa0střední\xa0Čechy\xa0– Tábor", 92_100_000, "FM"),
                ("Rock\xa0Radio\xa0Jižní\xa0a\xa0střední\xa0Čechy\xa0– České\xa0Budějovice", 97_300_000, "FM"),

                ("Rock\xa0Radio\xa0Západní\xa0Čechy\xa0– Kašperské\xa0Hory", 91_800_000, "FM"),
            ],
            "CB kanály": [
    ...
    def init_menu(self):
        ...
        memory_menu = menubar.addMenu("Paměti")
        for group, memories in self.memory_presets.items():
            sub = memory_menu.addMenu(group)
            for mem in memories:
                if isinstance(mem, tuple):
                    label, freq, mode = mem
                else:
                    # comprehension entry from PMR list
                    label, freq, mode = mem
                act = QAction(f"{label} ({freq/1_000_000:.3f} MHz)", self)
                act.setData((int(freq), mode))
                act.triggered.connect(self.tune_from_menu)
                sub.addAction(act)
