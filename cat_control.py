...
class FT897CAT:
    ...
    def get_meter_block(self) -> Optional[bytes]:
        """Read the 5-byte meter block using opcode 0xE7."""
        # The FT-897 responds with five bytes: S-meter, ALC, SWR,
        # FM deviation and supply voltage.  Using the simple
        # 5-byte CAT command avoids parsing errors some radios show
        # with the longer FE FE .. FD form.
