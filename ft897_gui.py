...
from PyQt5.QtCore import Qt, QThread, pyqtSignal, QTimer, QWIDGETSIZE_MAX
...
class RadioControlApp(QMainWindow):
    ...
    def adjust_all_fonts(self):
        ...
        self.freq_label.setMaximumSize(QWIDGETSIZE_MAX, QWIDGETSIZE_MAX)
        self.smeter_label.setMaximumSize(QWIDGETSIZE_MAX, QWIDGETSIZE_MAX)
