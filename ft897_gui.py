...
class RadioControlApp(QMainWindow):
    def __init__(self):
        ...
        # Preset frequencies for quick tuning. Each band key maps to a list of
        # tuples (label, frequency in Hz, mode code).
        freqs_80m = [
        ...
        self.band_presets = {
            "80 m": freqs_80m,
            "40 m": [("7.050 MHz", 7050000, 0x03)],
            "20 m": [("14.250 MHz", 14250000, 0x01)],
