...
class FT897CAT:
    """CAT control for the Yaesu FT-897 via rigctl CLI."""
    ...
    def connect(self, port, baudrate=9600):
        ...
        try:
            subprocess.check_call([
                "rigctl", "-m", "2", "-r", port, "-s", str(baudrate)
    ...
    def get_frequency(self):
        ...
        try:
            out = subprocess.check_output([
                "rigctl", "-m", "2", "-r", self.port, "-s", str(self.baudrate), "f"
    ...
    def get_smeter(self):
        ...
        try:
            out = subprocess.check_output([
                "rigctl", "-m", "2", "-r", self.port, "-s", str(self.baudrate), "l", "STRENGTH"
            ], stderr=subprocess.DEVNULL)
            return int(out.decode().strip())
        except Exception:
            return None
    ...
    def ptt_on(self):
        ...
        try:
            subprocess.check_call([
                "rigctl", "-m", "2", "-r", self.port, "-s", str(self.baudrate), "T", "1"
            ], stderr=subprocess.DEVNULL)
            return True
        except Exception:
            return False
    ...
    def ptt_off(self):
        ...
        try:
            subprocess.check_call([
                "rigctl", "-m", "2", "-r", self.port, "-s", str(self.baudrate), "T", "0"
            ], stderr=subprocess.DEVNULL)
            return True
        except Exception:
            return False
