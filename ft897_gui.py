...
class RadioControlApp(QMainWindow):
    ...
    def adjust_all_fonts(self):
        ...
        min_w = max(freq_rect.width(), sm_rect.width()) + 20
        min_h = max(freq_rect.height(), sm_rect.height()) + 20
        self.freq_label.setMinimumSize(min_w, min_h)
        self.smeter_label.setMinimumSize(min_w, min_h)
