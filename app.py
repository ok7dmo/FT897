    ...
    def __init__(self):
        ...
        self.memory_presets = {
            ...
            "70 cm": [
                ...
                # Explicitly provide zero repeater offset so the radio
                # reliably switches to simplex mode when selected.
                ("Rink", 433_275_000, "FM", 88.5, 0, True),
            ],
            "Převaděče": [
                # Gecko repeater with standard -0.6 MHz shift and TX-only CTCSS
