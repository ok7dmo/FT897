...
class RadioControlApp(QMainWindow):
    ...
    def adjust_all_fonts(self):
        ...
        # compute only frequency size
        freq_size = best_size(self.freq_label, sample_freq)
        # use same size for S-meter
        common_size = freq_size

        self.cached_freq_font = QFont(self.current_font_family, common_size, QFont.Bold)
        self.cached_smeter_font = QFont(self.current_font_family, common_size, QFont.Bold)
